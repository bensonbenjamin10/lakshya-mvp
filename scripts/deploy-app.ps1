# Deployment script for Flutter App
# This script builds and deploys the Flutter web app to Firebase Hosting

Write-Host "Starting Flutter app deployment..." -ForegroundColor Green
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "`nFlutter app deployment completed successfully!" -ForegroundColor Green
